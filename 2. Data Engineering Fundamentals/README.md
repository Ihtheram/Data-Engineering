...
### Data Mart
A subset of structured data from a data warehouse, optimized for fast access and simpler analytics for a particular group, such as Sales, Marketing, Finance, HR, and Operations. It contains only the data that the department needs, structured in a way that makes their reporting and analysis easier.
