...
* Tests can be run against your current project using a range of commands:
  ...
  * `dbt test --select one_specific_model`  
  ...
  Learn about tests in packages in free online course on [*Jinja, Macros, and Packages*](https://learn.getdbt.com/courses/jinja-macros-and-packages).  
  Check out free online course on [*Advanced Testing*](https://courses.getdbt.com/courses/advanced-testing)  
  </small>
